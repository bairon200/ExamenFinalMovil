...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtdescripcionr = findViewById(R.id.txtdescripcionr);
        txtPeriocidadr = findViewById(R.id.txtPeriocidadr);
        txttiempor = findViewById(R.id.txttiempor);
        txtCantidadr = findViewById(R.id.txtCantidadr);
